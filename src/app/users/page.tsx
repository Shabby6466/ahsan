  ...
  return (
    <body className="h-screen bg-gradient-to-b from-purple-600 to-white-900">
      ...
      <div className=' absolute top-100 left-10'>
        <p className='text-white w-[540px]'>Lorem ipsumdolor sit amet, consectetu arnum franum.
          Lorem ipsumdolor sit amet, consectetu arnum franum
          Lorem ipsumdolor sit amet, consectetu arnum franum
          Lorem ipsumdolor sit amet, consectetu arnum franum</p>
      </div>
      <div className='absolute top-130 left-10 flex flex-col gap-[20px]'>
        <input className='bg-white border border-white px-7 py-[12px] w-[350px] rounded-3xl' type="text" placeholder="Name" />
        <input className='bg-white border border-white px-7 py-[12px] w-[350px] rounded-3xl' type="email" placeholder="Email" />
      </div>
      <button className='absolute top-170 left-10 bg-yellow-300 border border-yellow-500 w-[110px] rounded-4xl h-[45px]'>Send</button>
    </body>
  );
};
