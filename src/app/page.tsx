      ...
      <form onSubmit={handleSubmit} className="p-4">
        <div className="w-[360px] h-[450px] border border-purple-500 rounded-lg bg-white shadow-lg">
          ...
          <div className="flex flex-col justify-start gap-3 px-4">
            <input
              className="border-2 border-gray-500 w-[300px] px-2 py-2 rounded-xl bg-white shadow-md"
              placeholder="Email"
              type="email"
            ></input>
          ...
          <div className="pl-4 flex flex-col gap-2 justify-start mb-2">
            <button className="bg-blue-500 text-white w-[300px] px-2 py-2 rounded-2xl font-semibold hover:bg-blue-600 active:scale-97 transition-all">
              {" "}
              Sign in{" "}
            </button>

            <button className="border border-black-500 w-[300px] px-2 py-2 flex items-center justify-center gap-2 rounded-2xl font-semibold hover:bg-gray-200 active:scale-97 transition-all">
